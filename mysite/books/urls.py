...
from books.views import add ,delete_book , update_book, borrrow_book, all_books, return_book, borrowed_books
...
urlpatterns = [
    ...
    path('borrow/<int:book_id>',borrrow_book, name='book.borrow'),
